...
const mealSlider = document.querySelector(".meals-slide");

for (const m of arr) {
  renderMeal(m);
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// FILTER THE MEALS
// const mealBtns = document.querySelectorAll(".meals-types-overview .tag");
// console.log(mealBtns);

// const mealBtnsContainer = document.querySelector(
//   ".meals-types-overview .meal-types-list"
// );
// let activeType = "";
// mealBtnsContainer.addEventListener("click", function (e) {
//   console.log(e.target);
//   if (!e.target.classList.contains("tag")) return;
//   resetMeal();
//   if (e.target.classList.contains("tag-active")) {
//     mealBtns.forEach((element) => {
...
//     for (const m of arr) {
//       if (m.categories.includes(e.target.getAttribute("name"))) renderMeal(m);
//     }
//   }
// });
{
